  ...
  return (
    <header data-ev-id="ev_14941de2e5" className="sticky top-0 z-40 bg-background/95 backdrop-blur-sm border-b border-border">
            ...
            className="flex items-center gap-3 focus-ring rounded-lg">
						...
						<div data-ev-id="ev_7a3df890b4" className="flex items-center justify-center w-9 h-9 rounded-lg bg-primary-muted border border-primary/30">
							<span data-ev-id="ev_707b01310a" className="text-sm font-bold text-primary">NA</span>
						</div>
